...
# Read data from S3
df1 = spark.read.parquet("s3://group-6-datalakenew/street/")
...
df1.write.mode("append").parquet("s3://group-6-datawarehousenew/STREET")

# Read data from outcomes for transformation
df2 = spark.read.parquet("s3://group-6-datalakenew/outcomes/")
...
df2.write.mode("append").parquet("s3://group-6-datawarehousenew/OUTCOMES")
