...
# Read data from S3
df1 = spark.read.parquet("s3://group-6-datalakenew23re/street/")
...
df1.write.mode("append").parquet("s3://group-6-datawarehousenewrte/STREET")

# Read data from outcomes for transformation
df2 = spark.read.parquet("s3://group-6-datalakenew23re/outcomes/")
...
df2.write.mode("append").parquet("s3://group-6-datawarehousenewrte/OUTCOMES")
